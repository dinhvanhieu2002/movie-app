...
class MediaListAdapter(val context: Context) : RecyclerView.Adapter<MediaListAdapter.MediaListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MediaListAdapter.MediaListViewHolder {
